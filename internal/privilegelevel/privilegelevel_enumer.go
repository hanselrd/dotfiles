// Code generated by "enumer -type PrivilegeLevel -trimprefix PrivilegeLevel -linecomment -json -text -transform lower"; DO NOT EDIT.
...
// UnmarshalJSON implements the json.Unmarshaler interface for PrivilegeLevel
func (i *PrivilegeLevel) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("PrivilegeLevel should be a string, got %s", data)
	}

	var err error
	*i, err = PrivilegeLevelString(s)
	return err
}
...
// UnmarshalText implements the encoding.TextUnmarshaler interface for PrivilegeLevel
func (i *PrivilegeLevel) UnmarshalText(text []byte) error {
	var err error
	*i, err = PrivilegeLevelString(string(text))
	return err
}
