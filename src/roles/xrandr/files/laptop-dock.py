...
if __name__ == "__main__":
    ...
    shell(
        f"xrandr --output {PRIMARY} --primary --mode 1920x1200 --pos 0x0 --rotate normal --output {DP__1_5} --mode 1920x1080 --pos 1920x60 --rotate normal --output {DP_} --mode 1920x1080 --pos 3840x60 --rotate normal {' '.join([f'--output {c} --off' for c in DISCONNECTED_MONITORS])}"
    )
