...
in  ''
    configuration {
    /*	modi: "window,run,ssh";*/
    	font: "${fontMetadata.launcher.name} ${External/Prelude.Text.default
                                              fontMetadata.launcher.style} ${External/Prelude.Natural.show
                                                                               fontMetadata.launcher.size}";
    /*	location: 0;*/
    /*	yoffset: 0;*/
    /*	xoffset: 0;*/
    ...
    @theme "${Directory/toText Directory.Rofi}/theme.rasi"
    ''
