...
class Offsets(gdb.Command):
    ...
    def _offsets(self, stype, sfield=None, indent=0):
        ...
        print(textwrap_indent('{} [{}] {{'.format(prefix, stype.sizeof), ' ' * 4 * indent))
        ...
        for field in stype.fields():
            ...
            if code is gdb.TYPE_CODE_STRUCT or code is gdb.TYPE_CODE_UNION:
                ...
                print(textwrap_indent('{}; => {} [{}]'.format(field.name, tmp3, field.type.sizeof), ' ' * 4 * (indent + 1)))
            last_field = field
        ...
        if sfield is None:
            ...
            print(textwrap_indent('}} {}; => {} [{}]'.format(sfield.name, tmp6, stype.sizeof), ' ' * 4 * indent))
